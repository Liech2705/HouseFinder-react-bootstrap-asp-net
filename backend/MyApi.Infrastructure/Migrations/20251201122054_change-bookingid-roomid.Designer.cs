...
namespace MyApi.Infrastructure.Migrations
{
    ...
    [Migration("20251201122054_change-bookingid-roomid")]
    partial class changebookingidroomid
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Review", b =>
                {
                    b.HasOne("MyApi.Domain.Entities.Booking", "Room")
                        .WithOne("Review")
                        .HasForeignKey("Review", "Room_Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
